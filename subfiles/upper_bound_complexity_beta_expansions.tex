...
\begin{proof}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \begin{equation}
            a_n \leq_n \sum_{i=1}^{n\log_\beta(2)} z_i \beta^{-i} \leq \sum_{i=1}^{m} z_i \beta^{-i} \leq \sum_{i=1}^{n\log_\beta(2)} z_i \beta^{-i} + \frac{\beta^{-n\log_\beta(2)}}{\beta-1} \leq_n b_n + \frac{\beta^{-n\log_\beta(2)}}{\beta-1},
        \end{equation}
        where (a) EXPLAIN. Hence, for every $z \in A_{m,n}$,
        \begin{equation}
...
\begin{proof}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item As a direct consequence, remark that by denoting $m_n$ to be the smallest distance between two different numbers of the form $\sum_{i=1}^{n\log_\beta(2)} x_i \beta^{-i}$, $x \in F_\beta(\yf_{1:n})$, we have that HERE MODIFY WITH THE APPROXIMATE COMPARISON
