...
\begin{proof}
    ...
    \begin{align}
        K[y|\beta] &\leq K[\xf_{1:n\log_\beta(2)}|\beta] + \log \left(\frac{1}{\beta-1} + 3\right) + \log\log \left(\frac{1}{\beta-1} + 3\right) + \bigOx[1]{n}\\
        &= K[\xf_{1:n\log_\beta(2)}|\beta] + \bigOx[1]{n},
    \end{align}
    ...
    Finally, this yields
    \begin{equation}
        \bar{\Delta}_{\beta}(\xf) \geq \underline{\Delta}_{\beta}(\xf) = \liminf_{n\to \infty} \frac{K[\xf_{1:n\log_\beta(2)}|\beta] - K[\yf_{1:n}|\beta]}{n} \geq \liminf_{n\to \infty}\bigOx[n^{-1}]{n} = 0.
    \end{equation}
\end{proof}
